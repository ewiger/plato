...
filetypes = {
    ...
    # regular file
    'f': 'file',
    # symbolic link; this is never true if the -L option or the -follow option is in effect, unless the symbolic link is broken.  If you want to search  for  symbolic  links  when  -L  is  in
    # effect, use -xtype.
    'l': 'link',
    's': 'socket',
    # door (Solaris)
